...
rule KeyPass_Rule
{
    ...
    strings:
        ...
        $ransom_text4 = "This price avaliable if you contact us first 72 hours."
        $ransom_text3 = "Very big trouble!!!!!!!!!"
        ransom_text3 = "keypassdecrypt@india.com"
        $contact = "BM-2cUMY51WfNRGBjGrWcHzTASeUGX84yX741@bitmessage.ch"
        ...
        $drive4 = "@f:\dd\vctools\vc7libs\ship\atlmfc\include\afxwin2.inl"
...
rule GravityRAT_Rule
{
    ...
    strings:
        ...
        $disk = "Win32_LogicalDisk" nocase
        $rawpass = "RawPassword" nocase
    ...
    condition:
       ...
       2 of ($string*)
       and
       (any of ($upload) or any of ($server) or any of ($ether) or any of ($mac) or any of ($netstat)) 
}
\end{lstlisting}
